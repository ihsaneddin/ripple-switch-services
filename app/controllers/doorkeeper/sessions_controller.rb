  ...
  class SessionsController < ::Doorkeeper::TokensController
    ...
    protected
      ...
      def response_body(response)
        resource_serializer = ::Users::Serializers::AccountSerializer.new(current_resource_owner(response.token.resource_owner_id))
        response_body= response.body.merge!({ resource_owner: resource_serializer.to_h }).to_json
      end
