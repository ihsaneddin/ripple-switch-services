...
(function ($) {
  ...
  var defaults = {
    title: 'Are you sure?',
    commit: 'Confirm',
    commitClass: 'btn-info',
    cancel: 'Cancel',
    cancelClass: 'btn-default',
    fade: true,
    verifyClass: 'form-control',
    pinClass: 'form-control',
  ...
  var buildElementModal = function (element) {
    var options = {
      ...
      pinLabel:     element.data('pin-label'),
  ...
  var buildModal = function (options) {
    ...
    var modalTitle = '<h4 id="'+id+'Label" class="modal-title"></h4> '
    ...
    if (options.pin){
      ...
      modal.on('hidden.bs.modal', function () {
        pin.val('').trigger('keyup');
      });
      if (options.pinLabel)
        body.append($('<p>', {text: options.pinLabel}))
  ...
  if ($.rails) {
    ...
    $(document).delegate(settings.elements.join(', '), 'confirm', function(e) {
        ...
        window.confirm = function (e) {
          if (element.data('pin')){
            ...
            if (element.hasClass('submit-modal-form')){
              ...
              {
                element.closest('form').append(pin)
              }
            }
          }
          return true;
