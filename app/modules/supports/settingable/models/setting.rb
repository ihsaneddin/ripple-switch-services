  ...
  module Settingable
    module Models
      class Setting < ApplicationRecord
        ...
        has_options fields: :_setting_options_fields,
                    validations: :_setting_options_validations,
                    prefix: :option,
                    column: :options
        ...
        def _setting_options
          settingable_type.constantize.setting_initialization_options rescue {}
        end

        def _setting_options_validations
          _setting_options[:validations]
        end

        def _setting_options_fields
          _setting_options[:options]
        end
