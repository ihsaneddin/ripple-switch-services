...
module Ripples
  module Workers
    ...
    class TransactionSubscriptionsWorker
      ...
      def perform(wss)
        ...
        params = { id: SecureRandom.urlsafe_base64(nil, false), accounts_proposed: Ripples::Models::Wallet.address_collection, command: "subscribe"}
